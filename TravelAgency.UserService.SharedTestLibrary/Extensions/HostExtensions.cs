...
namespace TravelAgency.UserService.SharedTestLibrary.Extensions;
public static class HostExtensions
{
    ...
    private static void MigrateDbContext<TContext>(IServiceScope scope, Action<TContext, IServiceProvider> seeder)
        where TContext : notnull, DbContext
    {
